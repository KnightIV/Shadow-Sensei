...
[System.Serializable]
public class InitFailedEvent : UnityEvent { }
...
public class NuitrackManager : MonoBehaviour
{
    ...
    [SerializeField] InitFailedEvent initFailedEvent;
    [SerializeField] UnityEvent initSuccessfulEvent;
    ...
    // TODO: maybe change this to public, depending on how to handle disconnected kinect
    void NuitrackInit()
    {
        ...
        try {
            #region Moved to different method
            ...
            InitSensors();
            initSuccessfulEvent?.Invoke();
        } catch (nuitrack.ModuleNotInitializedException) {
            initFailedEvent?.Invoke();
