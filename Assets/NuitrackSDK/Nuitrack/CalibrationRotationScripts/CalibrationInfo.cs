...
public class CalibrationInfo : MonoBehaviour 
{
    ...
    [Tooltip("Floor height tracking requires IsEnabled UserTracker module (in NuitrackManager component)")]
    ...
    public static void SetSensorHeightManually(float newHeight) //may be used when floor is not tracked / UserTracker not IsEnabled
    {
